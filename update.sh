...
update() {
echo -e "\e[32mDo you want to update mnszvirus? (y/n) \e[0m"
read ChB
...
echo -e "\e[92m mnszVirus Version 1.4 will be release soon. Once version 1.4 is released, some of the commands will be changed.\nBut worry not. All you have to do is to type: bash update.sh to update zVirus in version 1.4. As of now, you have to wait."
